...
public class EchoServer {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Buenos Dias, el servidor se encuentra en ejecucion y en espera de peticiones!");
       // Servidor esta ahora a la escucha ( esperando conexiones)
        try {
            ...
            while(listening) // bucle infinito
            {
                ...
                System.out.println("Hola Cliente!, ya te atendemos :D!!");
                ...
                {    
                    ...
                    int t=Integer.parseInt(part1);//tarjeta
                    Float monto=Float.parseFloat(part2);//monto
                    int cvv=Integer.parseInt(part3);//cvv
                    os.println(eo.pago(monto,t,cvv));//escribimos en el socket lo recibido mas mensaje
